%builtins output pedersen range_check // it's using 3 builts
...
// it's using a hash pointer which points to the memory segment of the pedersen
...
// it's using the output pointer (output_ptr) which points to the output built
...
// it's using range_check_ptr which points to the memory segment of range_check
...
// those previous functions are being used in this main function
